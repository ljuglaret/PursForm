...
(function($PS) {
  ...
  var indexUnsafeQ = function (elt) {
      return function (tab) {
          ...
          throw new Error("Failed pattern match at InfosReponses (line 62, column 3 - line 64, column 25): " + [ v.constructor.name ]);
      };
  };
  var indexUnsafe = function (elt) {
      return function (tab) {
          ...
          throw new Error("Failed pattern match at InfosReponses (line 56, column 3 - line 58, column 26): " + [ v.constructor.name ]);
      };
  };
  ...
  var showReponse = function (reponseCherchee) {
      return function (reponses) {
          return function (numero) {
              ...
              throw new Error("Failed pattern match at InfosReponses (line 50, column 5 - line 52, column 46): " + [ v.constructor.name ]);
          };
      };
  };
          ...
          var aux = function ($copy_l2) {
              return function ($copy_acc) {
                  ...
                  function $tco_loop(l2, acc) {
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var $26 = occurences(dictEq)(v.value0.head)(acc) === 0;
                          if ($26) {
                      ...
                      throw new Error("Failed pattern match at InfosReponses (line 90, column 7 - line 96, column 23): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
  ...
  var associe = function (reponsesDuFormulaire) {
      return function (reponseCherchee) {
          return function (numQuestion) {
              ...
              throw new Error("Failed pattern match at InfosReponses (line 75, column 4 - line 80, column 20): " + [ v.constructor.name ]);
          };
      };
  };
          ...
          return function (reponsesFormulaire) {
              return Data_Foldable.foldr(dictFoldable)(function (repf) {
                  return function (accScore) {
                      var $36 = bonneReponseDonnee(repf)(reponsesFormulaire);
                      if ($36) {
  ...
  var score = function (reponsesDonnees) {
      return function (reponsesFormulaire) {
          return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (repf) {
              return function (accScore) {
                  var $37 = bonneReponseDonnee(repf)(reponsesFormulaire);
                  if ($37) {
                      return accScore + 1.0;
                  };
                  return accScore - 0.5;
...
(function($PS) {
  ...
  var FormulaireVide = (function () {
      function FormulaireVide() {

      };
      FormulaireVide.value = new FormulaireVide();
  ...
  var update = function (v) {
      ...
      if (v instanceof EnvoiReponsesFormulaire) {
          ...
          if ($18) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $19.stage = new ResultatUnePartie(v.value0, Data_Array.cons(v.value1)(v.value2), v.value3);
                  return $19;
              });
          };
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $22.stage = new ScoreFinal(v.value2);
              return $22;
          });
      };
      if (v instanceof RecommencerUnePartie) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $29.stage = new Formulaire([  ], v.value0, v.value1 + 1 | 0);
              return $29;
          });
      };
  ...
  var render = function (v) {
      if (v.stage instanceof Presentation) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Les r\xe8gles sont les suivantes  : ") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("+ 1 point pour une bonne r\xe9ponses") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("- 0.5 point pour une mauvaise r\xe9ponse") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("3 essais sont autoris\xe9s") ]), renderNextButton(new Data_Maybe.Just(FormulaireVide.value))("Commencer") ]);
      };
      ...
      if (v.stage instanceof ScoreFinal) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Votre moyenne est de : ") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)(Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semiring.add(Data_Semiring.semiringNumber))(0.0)(v.stage.value0) / Data_Int.toNumber(Data_Array.length(v.stage.value0)))) ]), renderNextButton(new Data_Maybe.Just(FormulaireVide.value))("Recommencer") ]);
      };
