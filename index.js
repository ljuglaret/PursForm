...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["InfosReponses"] = $PS["InfosReponses"] || {};
  var exports = $PS["InfosReponses"];
  ...
  var Reponse1 = (function () {
      function Reponse1() {

      };
      Reponse1.value = new Reponse1();
      return Reponse1;
  })();
  var Reponse2 = (function () {
      function Reponse2() {

      };
      Reponse2.value = new Reponse2();
      return Reponse2;
  })();
  var Reponse3 = (function () {
      function Reponse3() {

      };
      Reponse3.value = new Reponse3();
      return Reponse3;
  })();
  var Reponse4 = (function () {
      function Reponse4() {

      };
      Reponse4.value = new Reponse4();
      return Reponse4;
  })();
  var Reponse5 = (function () {
      function Reponse5() {

      };
      Reponse5.value = new Reponse5();
      return Reponse5;
  })();
  var Reponse6 = (function () {
      function Reponse6() {

      };
      Reponse6.value = new Reponse6();
      return Reponse6;
  })();
  var Reponse7 = (function () {
      function Reponse7() {

      };
      Reponse7.value = new Reponse7();
      return Reponse7;
  })();
  var Reponse8 = (function () {
      function Reponse8() {

      };
      Reponse8.value = new Reponse8();
      return Reponse8;
  })();
  ...
  var Question2 = (function () {
      ...
      Question2.value = new Question2();
      return Question2;
  })();
  var showQuestion = function (question) {
      if (question instanceof Question1) {
          return "Cochez la case si l'animal est un mamif\xe8re";
      };
      if (question instanceof Question2) {
          return "Cochez la case si l'animal mesure plus de 2 m\xe8tres";
      };
      throw new Error("Failed pattern match at InfosReponses (line 43, column 3 - line 45, column 71): " + [ question.constructor.name ]);
  };
  var reponsesQ2 = {
      numeroQuestion: 2,
      listeDesReponses: [ {
          ...
          reponse: Reponse2.value,
          nom: "Autruche",
          id: 1,
          correct: true
      }, {
          reponse: Reponse3.value,
          nom: "Elephant",
          id: 2,
          correct: true
      }, {
          reponse: Reponse4.value,
          nom: "Chien",
          id: 3,
          correct: false
      } ]
  ...
  var reponsesQ1 = {
      ...
      listeDesReponses: [ {
          ...
          reponse: Reponse5.value,
          nom: "Poisson",
          id: 4,
          correct: false
      } ]
  };
  var reponsesCorrectes = function (reponses) {
      return Data_Functor.map(Data_Functor.functorArray)(function (record) {
          return {
              numQ: record.numeroQuestion,
              rep: Data_Functor.map(Data_Functor.functorArray)(function (detail) {
                  return detail.id;
              })(Data_Array.filter(function (rec) {
                  return rec.correct === true;
              })(record.listeDesReponses))
          };
      })(reponses);
  };
  var occurences = function (dictEq) {
      return function (reponse) {
          return function (listeReponse) {
              return Data_Array.length(Data_Array.filter(function (p) {
                  return Data_Eq.eq(dictEq)(p)(reponse);
              })(listeReponse));
          };
      };
  };
  var listReponses = [ reponsesQ1, reponsesQ2 ];
  var listQuestions = [ Question1.value, Question2.value ];
  var indexUnsafeQ = function (elt) {
      return function (tab) {
          var v = Data_Array.index(elt)(tab);
          if (v instanceof Data_Maybe.Just) {
              return v.value0;
          };
          if (v instanceof Data_Maybe.Nothing) {
          ...
          throw new Error("Failed pattern match at InfosReponses (line 61, column 3 - line 63, column 25): " + [ v.constructor.name ]);
      };
  };
  var indexUnsafe = function (elt) {
      return function (tab) {
          var v = Data_Array.index(elt)(tab);
          if (v instanceof Data_Maybe.Just) {
              return v.value0;
          ...
          throw new Error("Failed pattern match at InfosReponses (line 55, column 3 - line 57, column 26): " + [ v.constructor.name ]);
      };
  };
  var eqReponses = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Reponse1 && y instanceof Reponse1) {
              return true;
          };
          if (x instanceof Reponse2 && y instanceof Reponse2) {
              return true;
          };
          if (x instanceof Reponse3 && y instanceof Reponse3) {
              return true;
          };
          if (x instanceof Reponse4 && y instanceof Reponse4) {
              return true;
          };
          if (x instanceof Reponse5 && y instanceof Reponse5) {
              return true;
          };
          if (x instanceof Reponse6 && y instanceof Reponse6) {
              return true;
          };
          if (x instanceof Reponse7 && y instanceof Reponse7) {
              return true;
          };
          if (x instanceof Reponse8 && y instanceof Reponse8) {
              return true;
          };
          return false;
      };
  });
  var showReponse = function (reponseCherchee) {
      return function (reponses) {
          return function (numero) {
              var v = Data_Array.head(Data_Array.filter(function (record) {
                  return Data_Eq.eq(eqReponses)(record.reponse)(reponseCherchee.reponse) && reponseCherchee.numQ === numero;
              })(reponses.listeDesReponses));
              if (v instanceof Data_Maybe.Just) {
                  return v.value0.nom;
              };
              if (v instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at InfosReponses (line 49, column 5 - line 51, column 46): " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var enleveDoublons = function (dictEq) {
      return function (l) {
          var aux = function ($copy_l2) {
              return function ($copy_acc) {
                  var $tco_var_l2 = $copy_l2;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(l2, acc) {
                      var v = Data_Array.uncons(l2);
                      if (v instanceof Data_Maybe.Just) {
                          var $24 = occurences(dictEq)(v.value0.head)(acc) === 0;
                          if ($24) {
                              $tco_var_l2 = v.value0.tail;
                              $copy_acc = Data_Array.cons(v.value0.head)(acc);
                              return;
                          };
                          $tco_var_l2 = v.value0.tail;
                          $copy_acc = acc;
                      ...
                      throw new Error("Failed pattern match at InfosReponses (line 89, column 7 - line 95, column 23): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_l2, $copy_acc);
                  };
                  return $tco_result;
              };
          };
  ...
  var enleveDeclic = function (arr) {
      return Data_Array.sortBy(function (rec1) {
          return function (rec2) {
              return Data_Ord.compare(Data_Ord.ordInt)(rec1.numQ)(rec2.numQ);
          };
      })(enleveDoublons(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          return "reponse";
      }))(eqReponses))()(new Data_Symbol.IsSymbol(function () {
          return "numQ";
      }))(Data_Eq.eqInt)))(Data_Array.filter(function (rec) {
          return Data_Int.odd(occurences(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "reponse";
          }))(eqReponses))()(new Data_Symbol.IsSymbol(function () {
              return "numQ";
          }))(Data_Eq.eqInt)))(rec)(arr));
      })(arr)));
  };
  var distribue = function (arr) {
      return Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(function (rec) {
          return Data_Functor.map(Data_Functor.functorArray)(function (eltTab) {
              return {
                  numQ: rec.numQ,
                  rep: eltTab
              };
  ...
  var associe = function (reponsesDuFormulaire) {
      return function (reponseCherchee) {
          return function (numQuestion) {
              var v = Data_Array.head(Data_Array.filter(function (record) {
                  return Data_Eq.eq(eqReponses)(record.reponse)(reponseCherchee);
              })(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(function (rep) {
                  return rep.listeDesReponses;
              })(Data_Array.filter(function (rep) {
                  return rep.numeroQuestion === numQuestion;
              })(reponsesDuFormulaire)))));
              if (v instanceof Data_Maybe.Just) {
                  return v.value0.id;
              };
              if (v instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at InfosReponses (line 74, column 4 - line 79, column 20): " + [ v.constructor.name ]);
          };
      };
  };
  var bonneReponseDonnee = function (reponseDonnee) {
      return function (reponsesFormulaires) {
          return occurences(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "rep";
          }))(Data_Eq.eqInt))()(new Data_Symbol.IsSymbol(function () {
              return "numQ";
          }))(Data_Eq.eqInt)))({
              numQ: reponseDonnee.numQ,
              rep: associe(reponsesFormulaires)(reponseDonnee.reponse)(reponseDonnee.numQ)
          })(distribue(reponsesCorrectes(reponsesFormulaires))) === 1;
      };
  };
  var correctionQ = function (dictFoldable) {
      return function (reponsesDonnees) {
          return function (reponsesFormulaire) {
              return Data_Foldable.foldr(dictFoldable)(function (repf) {
                  return function (accScore) {
                      var $30 = bonneReponseDonnee(repf)(reponsesFormulaire);
                      if ($30) {
                          return Data_Array.cons(Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("repCorrecte") ])([ Halogen_HTML_Core.text(showReponses([ repf ])(reponsesFormulaire) + " : Vrai ") ]))(accScore);
                      };
                      return Data_Array.cons(Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("repFausse") ])([ Halogen_HTML_Core.text(showReponses([ repf ])(reponsesFormulaire) + " : Faux") ]))(accScore);
                  };
              })([  ])(reponsesDonnees);
          };
      };
  };
  var correction = function (reponsesDonnees) {
      return function (reponsesFormulaire) {
          return Data_Functor.map(Data_Functor.functorArray)(function (repF) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(showQuestion(indexUnsafeQ(listQuestions)(Data_Maybe.maybe(0)(function (tete) {
                  return tete.numQ;
              })(Data_Array.head(repF))))) ]), Halogen_HTML_Elements.div_(correctionQ(Data_Foldable.foldableArray)(repF)(reponsesFormulaire)) ]);
          })(Data_Functor.map(Data_Functor.functorArray)(Data_Array_NonEmpty.toArray)(Data_Array.groupBy(function (rec1) {
              return function (rec2) {
                  return rec1.numQ === rec2.numQ;
              };
          })(reponsesDonnees)));
      };
  };
  var score = function (reponsesDonnees) {
      return function (reponsesFormulaire) {
          return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (repf) {
              return function (accScore) {
                  var $31 = bonneReponseDonnee(repf)(reponsesFormulaire);
                  if ($31) {
                      return accScore + 1 | 0;
                  };
                  return accScore - 1 | 0;
  ...
  exports["showReponse"] = showReponse;
  exports["indexUnsafe"] = indexUnsafe;
  exports["indexUnsafeQ"] = indexUnsafeQ;
  exports["enleveDeclic"] = enleveDeclic;
  exports["score"] = score;
  exports["correction"] = correction;
  exports["listReponses"] = listReponses;
...
(function($PS) {
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var InfosReponses = $PS["InfosReponses"];                
  ...
  var ScoreFinal = (function () {
      function ScoreFinal(value0) {
          this.value0 = value0;
      };
      ScoreFinal.create = function (value0) {
          return new ScoreFinal(value0);
      };
      return ScoreFinal;
  })();
  var StockeReponse = (function () {
      function StockeReponse(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      StockeReponse.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new StockeReponse(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var EnvoiReponsesFormulaire = (function () {
      function EnvoiReponsesFormulaire(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      EnvoiReponsesFormulaire.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new EnvoiReponsesFormulaire(value0, value1, value2);
              };
          };
      };
  ...
  var Recommencer = (function () {
      function Recommencer(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Recommencer.create = function (value0) {
          return function (value1) {
              return new Recommencer(value0, value1);
          };
      };
      return Recommencer;
  })();
  ...
  var update = function (v) {
      if (v instanceof EnvoiScore) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $8.stage = new ScoreFinal(v.value0);
              return $8;
          });
      };
      if (v instanceof Recommencer) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              var $12 = {};
              for (var $13 in v1) {
              ...
              $12.stage = new Formulaire(v.value0, v.value1);
              return $12;
          });
      };
      if (v instanceof EnvoiReponsesFormulaire) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $17.stage = new ResultatUnePartie(v.value0, Data_Array.cons(v.value1)(v.value2));
              return $17;
          });
      };
      if (v instanceof StockeReponse) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $23.stage = new Formulaire(InfosReponses.enleveDeclic(Data_Array.cons({
                  numQ: v.value2,
                  reponse: v.value0
              })(v.value1)), v.value3);
              return $23;
      ...
      throw new Error("Failed pattern match at Form (line 45, column 1 - line 45, column 63): " + [ v.constructor.name ]);
  };
  var renderNextButton = function (action) {
      return function (texteBouton) {
          return Halogen_HTML_Elements.button((function () {
              ...
              throw new Error("Failed pattern match at Form (line 68, column 5 - line 70, column 62): " + [ action.constructor.name ]);
          })())([ Halogen_HTML_Core.text(texteBouton) ]);
      };
  };
  var render = function (v) {
      if (v.stage instanceof Formulaire) {
          var makeButton = function (reponseDonnee) {
              return function (numRep) {
                  return function (numQuestion) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Events.onChecked(function (b) {
                          return Data_Maybe.Just.create(new StockeReponse(reponseDonnee, v.stage.value0, numQuestion, v.stage.value1));
          ...
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([  ])(Data_Functor.map(Data_Functor.functorArray)(function (indice) {
              var reponse = InfosReponses.indexUnsafe(InfosReponses.listReponses)(indice - 1 | 0);
              var question = InfosReponses.indexUnsafeQ(InfosReponses.listQuestions)(indice - 1 | 0);
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(InfosReponses.showQuestion(question)) ]), Halogen_HTML_Elements.p_(Data_Functor.map(Data_Functor.functorArray)(function (record) {
                  return makeButton(record.reponse)(reponse)(indice);
              })(reponse.listeDesReponses)) ]);
          })([ 1, 2 ])), renderNextButton(new Data_Maybe.Just(new EnvoiReponsesFormulaire(v.stage.value0, InfosReponses.score(v.stage.value0)(InfosReponses.listReponses), v.stage.value1)))("Score") ]);
      };
      if (v.stage instanceof ResultatUnePartie) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("body") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("haut") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Votre score est de : " + Data_Show.show(Data_Show.showInt)(InfosReponses.score(v.stage.value0)(InfosReponses.listReponses))) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Voici la correction ") ]), Halogen_HTML_Elements.div_(InfosReponses.correction(v.stage.value0)(InfosReponses.listReponses)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("bas") ])([ renderNextButton(new Data_Maybe.Just(new Recommencer([  ], v.stage.value1)))("Recommencer"), renderNextButton(new Data_Maybe.Just(new EnvoiScore(v.stage.value1)))("Score Final") ]) ]);
      };
      if (v.stage instanceof ScoreFinal) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Votre score final est de : ") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semiring.add(Data_Semiring.semiringInt))(0)(v.stage.value0))) ]), renderNextButton(new Data_Maybe.Just(new Recommencer([  ], [  ])))("Recommencer") ]);
      };
      throw new Error("Failed pattern match at Form (line 73, column 1 - line 73, column 54): " + [ v.constructor.name ]);
  };
  var initialState = {
      stage: new Formulaire([  ], [  ])
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Form.page)(Data_Unit.unit)));
  exports["main"] = main;
})(PS);
PS["Main"].main();